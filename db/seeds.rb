...
Surgery1 = Surgery.create(time:8)
Surgery2 = Surgery.create(time:9)
Surgery3 = Surgery.create(time:10)
Surgery4 = Surgery.create(time:11)
Surgery5 = Surgery.create(time:5)
